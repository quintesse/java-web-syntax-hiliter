...
public class PatchTokenMarker extends TokenMarker {
	...
	public byte markTokensImpl(byte token, Segment line, int lineIndex) {
		...
		case '+':
		case '>':
			addToken(line, line.offset, line.count, Token.KEYWORD1);
			break;
		case '-':
		case '<':
			addToken(line, line.offset, line.count, Token.KEYWORD2);
			break;
		case '@':
		case '*':
			addToken(line, line.offset, line.count, Token.KEYWORD3);
			break;
		default:
			addToken(line, line.offset, line.count, Token.NULL);
		break;
		}
		return Token.NULL;
	}
