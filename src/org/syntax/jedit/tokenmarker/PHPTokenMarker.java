...
public class PHPTokenMarker extends TokenMarker {
	...
	public byte markTokensImpl(byte token, Segment line, int lineIndex) {
			...
			case SCRIPT: // Inside a JavaScript or PHP
				...
				case '<':
					...
					if (SyntaxUtilities.regionMatches(true, line, i1, "/script>")) {
						// Ending the script
						addToken(line, lastOffset, i - lastOffset, Token.KEYWORD3);
						addToken(line, i, 9, Token.LABEL);
				...
				case '#':
					doKeyword(line, i, c);
					addToken(line, lastOffset, i - lastOffset, Token.KEYWORD3);
					addToken(line, i, lineLength - i, Token.COMMENT2);
		...
		case SCRIPT:
			...
			addToken(line, lastOffset, lineLength - lastOffset, Token.KEYWORD3);
			break;
		default:
	...
	private boolean doKeyword(Segment line, int i, char c) {
		...
		if (id != Token.NULL) {
			if (lastKeyword != lastOffset)
				addToken(line, lastOffset, lastKeyword - lastOffset, Token.KEYWORD3);
