...
public class Token {
	...
	/**
	 * Label token id. This can be used to mark labels (eg, C mode uses this
	 * to mark ...: sequences)
	 */
	...
	/**
	 * Operator token id. This can be used to mark an operator. (eg, SQL
	 * mode marks +, -, etc with this token type)
	 */
	public static final byte OPERATOR = 9;

	/**
	 * Invalid token id. This can be used to mark invalid or incomplete
	 * tokens, so the user can easily spot syntax errors.
	 */
	...
	/**
	 * The token type, that along with a length of 0 marks the end of the
	 * token list.
	 */
	public static final byte END = 127;

	/**
	 * The line segment for this token
	 */
	public Segment line;

	/**
	 * The offset of the token within the line.
	 */
	public int offset;
	 ...
	 * Creates a new token.
	 * 
	 * @param line The line segment for this Token
	 * @param offset The offset of the token within the line
	 * @param length The length of the token
	 * @param id The id of the token
	 */
	public Token(Segment line, int offset, int length, byte id) {
		this.line = line;
		this.offset = offset;
		this.length = length;
		this.id = id;
	...
	public String getText() {
		return new String(line.array, offset, length);
	}
